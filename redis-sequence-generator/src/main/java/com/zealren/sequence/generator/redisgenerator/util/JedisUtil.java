package com.zealren.sequence.generator.redisgenerator.util;
...
public class JedisUtil {
     ...
     * @param key
     * @param value
     * @param minute 过期时间,分钟单位
     */
    public void setForTimeMinute(String key, String value, long minute) {
        redisTemplate.opsForValue().set(key, value, minute, TimeUnit.MINUTES);
    }


    /**
     * 设置 String 类型 key-value 并添加过期时间及单位
     *
     * @param key
     * @param value
     * @param time  过期时间
